...
- - -
![Canons Pilates Brand Logo Image](documentation/brand-logo.png)
...
## **Contact Us Page** 
 * The information will provide Address, phone number and email address. It will we identical to the information on the Contact section in the footer. The Contact link is also accessible from the Quick Links section. The address section will contact a map which is clickable directing you to googlemaps site.
 
![Contact Section](documentation/contactus.png)
...
| Check carousel is operational, images displayed fully and clearly.                              | Inspected on devtools, carousel operational , no errors displayed                                                                | Carousel displayed                                                                                                                                              |
| Checked Carousel is autoplaying 4 images and can be navigated left and right using indicators   | Inspected on devtools, checked responsiveness, carousel operational , no errors displayed                                        | Carousel responsive, autoplaying and and can be manually selected left and right.                                                                               |
| Access Home page link                                                                           | From home page select home on navigation bar and quick links on footer                                                           | Site remains on Home page                                                                                                                                       |
| Access Classes page link                                                                        | From home page click Classes on navigation bar and quick links on footer section                                                 | Site directs to Classes page ( can  also be accessed from classes,contact and booking page)                                                                     |
| Access Contact Us link                                                                          | From home page click Contact Us on navigation bar and quick links on footer section                                              | Site directs to Contact Us page  ( can also be accessed from classes,contact and booking page)                                                                  |
| Access Booking page                                                                             | From home page click Book Now button on navigation bar and Book now  from quick links on footer section                          | Site directs to Bookings page  ( can  also be accessed from classes,contact and booking page)                                                                   |
| Each booking form field required to input data before submitting                                | Clicked submit button, whilst missing an input field to complete.                                                                | Form does not send and message asks 'Please fill in this field                                                                                                  |
| Ensuring correct email address format entered in field                                          | Entered email address without including an @ symbol.                                                                             | Form does not send and message asks 'Please include an '@' in the email address'                                                                                |
| Receiving a thank-you confirmation message after submitting the booking form.                   | Completed the booking form accurately, entered submit                                                                            | Received thank-you confirmation, with the option to take user back to Home page                                                                                 |
| Confirm compose message window  opens up when clicking email address link in Contact Us section | Navigated to Contact Us Section on Navigation bar and Footer within Contact Section and click email address canons@pilates.co.uk | Based on your default mail client settings, a seperate compose message window opens up with correct email address  in recepient field, within your mail client. |
| Confirm ability make a phone call to number when clicking Phone number in Contact Section       | Navigated to Contact Us Section on Navigation bar and Footer within Contact Section and click phone                              | When using a mobile device, it will dial a number. When using a laptop , it will prompt you to select an application.                                           |
...
| Footer too high                                                                                         | Adjusted footer properties in, by creating a margin-top,.                                                                                                                                                                             | Yes      |
| Contact navigation link not pointing to contact section on footer                                       | Created new contact page  with contact page nav links on each site page                                                                                                                                                               | Yes      |
| performance on site too low when using lighthouse impacted by images                                    | resized and compressed images using Adobe Express                                                                                                                                                                                     | Yes      |
| Contact section contained all headings and content on one column, making page look untidy and scattered | Applied bootstrap grid system using col-md-4 to create 3 seperate colums vertically, Styled properties to display an equal width layout.                                                                                              | Yes      |
